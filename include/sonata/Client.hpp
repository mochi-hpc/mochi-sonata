...
public:
   ...
   */
  Database open(const std::string &address, uint16_t provider_id,
                const std::string &db_name, bool check = true) const;
   ...
   * @return a Database instance.
   */
  Database open(const ProviderHandle &ph, const std::string &db_name,
