...
static ABTSyMutex aStaticMutexes[] = {{ABT_MUTEX_NULL, SXMUTEX_TYPE_STATIC_1},
...
static const SyMutexMethods sABTMutexMethods = {
    ABTMutexGlobalInit, ABTMutexGlobalRelease, ABTMutexNew,  ABTMutexRelease,
    ABTMutexEnter,      ABTMutexTryEnter,      ABTMutexLeave};
