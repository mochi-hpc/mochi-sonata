...
std::unique_ptr<Backend> NullBackend::create(const tl::engine& engine, const tl::pool& pool, const Json::Value& config) {
...
std::unique_ptr<Backend> NullBackend::attach(const tl::engine& engine, const tl::pool& pool, const Json::Value& config) {
